...
1 # 10  # N forecast years
1 # 0.2  # F scalar (only used for Do_Forecast==5)
# #_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF, beg_recruits, end_recruits  (enter actual year, or values of 0 or -integer to be rel. endyr)
0 0 0 0 0 0
0    # Forecast selectivity option
...
0    # Forecast recruitment
1    # Scaler or N years recent main recruitments to average
